"""13 Maret 2025 12:56 fix table memo and add table doc archive

Revision ID: 5385fc28d8b3
Revises: d2e1c7016f8c
Create Date: 2025-03-13 13:24:55.490068
...
def upgrade() -> None:
    ...
    sa.Column('outgoing_doc_type', sa.Enum('ASLI', 'COPY', 'TRANSFER', name='outgoingtodoctype'), nullable=True),
    ...
    sa.Column('notaris_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('doc_format_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('project_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('physical_doc_type', sa.Enum('ASLI', 'DUPLIKAT', 'COPY', 'LEGALISIR', 'SALINAN', name='typedocfisikenum'), nullable=True),
    sa.Column('remarks', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('jenis_arsip', sa.Enum('ARSIP_HOLDING', 'ARSIP_AJB', name='jenisarsipenum'), nullable=True),
