...
# @router.post("", response_model=PostResponseBaseSch[list[DocumentTypeGroupSch]], status_code=status.HTTP_201_CREATED)
...
#     obj = await crud.document_type_group.create(sch=sch, created_by=login_user.client_id)
#     return create_response(data=obj)
...
#     obj_updated = await crud.document_type_group.update(obj_current=obj_current, obj_new=obj_new, updated_by=login_user.client_id)
