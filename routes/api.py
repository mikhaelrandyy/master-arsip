...
from routes.endpoints import doc_type_jenis_kolom, document_format, document_type, document_type_group, jenis_kolom, doc_type_jenis_kolom
...
api_router.include_router(doc_type_jenis_kolom.router, prefix="/doc-type/jenis-kolom", tags=["doc_type_jenis_kolom"])
