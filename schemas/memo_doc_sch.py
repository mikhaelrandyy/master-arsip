...
class MemoDocSch(MemoDocFullBase):
    memo_doc_attachments: list[MemoDocAttachmentSch] | None = None
    memo_doc_columns: list[MemoDocColumnSch] | None = None
    memo_doc_asal_haks: list[MemoDocAsalHakSch] | None = None
